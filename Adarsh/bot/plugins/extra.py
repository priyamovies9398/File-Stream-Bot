    ...
    try:
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="ɪ  ᴀᴍ  ᴍᴀɪɴᴛᴀɪɴᴇᴅ  ʙʏ  [PRIYA](https://telegram.me/Sai_File_Store_CC)",
                    
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ   🧑‍💻", url=f"https://t.me/djreme")
                            ]
                        ]
                    ),
...
async def follow_user(b,m):
    btn = [[
        InlineKeyboardButton(text="Main Channal", url="https://t.me/Sai_File_Store_CC"),
        InlineKeyboardButton(text="Developed BY", url="https://t.me/PriyaMovis")
        ],[
        InlineKeyboardButton(text="ᴏᴜʀ  ᴏꜰꜰɪᴄɪᴀʟ  ᴄʜᴀɴɴᴇʟ", url="https://t.me/Sai_File_Store")
    ],[
        InlineKeyboardButton(text="ꜱᴜʙꜱᴄʀɪʙᴇ To Channal", url="https://t.me/Sai_File_Store_CC")
    ],[
        InlineKeyboardButton(text="ɢɪᴛʜᴜʙ", url="google.com"),
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇꜱ", url="https://t.me/Sai_File_Store_CC")
    ]]
    try:
       await b.send_message(chat_id=m.chat.id,text="HELLO",quote=True)
    except Exception:
